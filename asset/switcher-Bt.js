...
pc.addEventListener('click',()=>{
    ...
    desgin.innerHTML='<picture> <source src="../images/Works/pasta/pcFull-pasta.avif"> <img src="../images/Works/pasta/pcFull-pasta.webp" load="lazy" alt="制作したデザイン"></picture>';
    desgin.classList.remove('sp-size');
});
sp.addEventListener('click',()=>{
    sp.classList.add('switch-active');
    pc.classList.remove('switch-active');
    desgin.innerHTML='<picture> <source src="../images/Works/pasta/spFull-pasta.avif"> <img src="../images/Works/pasta/spFull-pasta.webp" load="lazy" alt="制作したデザイン"></picture>';
